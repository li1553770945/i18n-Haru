...
url = 'https://www.iconfont.cn/api/project/download.zip?spm=a313x.manage_type_myprojects.i1.d7543c303.30913a8111wqCX&pid=4728444&ctoken=cJbdD9qha65tIFXXR6y9_je6'
...
# 将文件搬运至工作区，我的 css 全放在 icons 下面了，你的视情况而定
for parent, _, files in os.walk('./script/tmp'):
    for file in files:
        ...
        if file.endswith('.css'):
            ...
            shutil.move(filepath, os.path.join('./icons', file))
